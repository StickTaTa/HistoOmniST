...
from histoomnist.external.train_thitogene_sourcefaithful import (  # noqa: E402
    data_smoke_summary,
    export_thitogene_sourcefaithful_predictions,
    forward_smoke_summary,
    train_thitogene_sourcefaithful,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train source-faithful THItoGene on HEST full-slide patch H5 data."
    )
    ...
    parser.add_argument("--output-dir", default="checkpoints/hest1k_human_visium_expression_external/thitogene_sourcefaithful_smoke")
    parser.add_argument("--prediction-root", default="results/hest1k_human_visium_expression/external_baselines/thitogene_sourcefaithful_predictions")
    parser.add_argument("--benchmark-out-dir", default="results/hest1k_human_visium_expression/benchmark_results/thitogene_sourcefaithful")
...
def main() -> None:
    ...
    if args.forward_smoke and (args.max_spots_per_slide is not None or args.max_slide_spots is not None):
        raise ValueError("Forward smoke for source-faithful THItoGene must not use spot truncation.")
    ...
    train_summary = train_thitogene_sourcefaithful(
        expression_config=cfg,
    ...
    if args.export_predictions or args.evaluate_predictions:
        ...
        prediction_summary = export_thitogene_sourcefaithful_predictions(
            expression_config=cfg,
        ...
        if args.evaluate_predictions:
            ...
            benchmark_summary = evaluate_prediction_bundle(
                ...
                method_name="thitogene_sourcefaithful",
