...
from histoomnist.external.train_histogene_sourcefaithful import (  # noqa: E402
    data_smoke_summary,
    export_histogene_sourcefaithful_predictions,
    train_histogene_sourcefaithful,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train source-faithful HisToGene on HEST full-slide patch H5 data."
    )
    ...
    parser.add_argument("--output-dir", default="checkpoints/hest1k_human_visium_expression_external/histogene_sourcefaithful")
    parser.add_argument("--prediction-root", default="results/hest1k_human_visium_expression/external_baselines/histogene_sourcefaithful_predictions")
    parser.add_argument("--benchmark-out-dir", default="results/hest1k_human_visium_expression/benchmark_results/histogene_sourcefaithful")
...
def main() -> None:
    ...
    train_summary = train_histogene_sourcefaithful(
        expression_config=cfg,
    ...
    if args.export_predictions or args.evaluate_predictions:
        ...
        prediction_summary = export_histogene_sourcefaithful_predictions(
            expression_config=cfg,
        ...
        if args.evaluate_predictions:
            ...
            benchmark_summary = evaluate_prediction_bundle(
                ...
                method_name="histogene_sourcefaithful",
